...
import com.motcs.core.document.DocumentStatsResponse;
import com.motcs.core.document.DocumentSummary;
import com.motcs.core.knowledge.KnowledgeEntity;
import com.motcs.core.knowledge.graph.GraphRagResult;
...
public interface DocumentChunkRepository extends Neo4jRepository<DocumentChunk, String> {
    ...
    @Query("""
            MATCH (chunk:DocumentChunk)
             ...
             AND ($tenantCode = '0' OR ((chunk.tenantCode = $tenantCode AND chunk.systemType = $systemType) OR chunk.tenantCode = '0'))
             ...
             WHERE otherChunk IS NULL OR ($tenantCode = '0' OR (((otherChunk.tenantCode = $tenantCode
             AND otherChunk.systemType = $systemType) OR otherChunk.tenantCode = '0')
             ...
             LIMIT $limit
            """)
    List<GraphRagResult> multiHopRetrieve(
    ...
    @Query("""
            ...
            WHERE $tenantCode IS NULL OR $tenantCode = '0' OR c.tenantCode = $tenantCode OR c.tenantCode = '0'
