...
import com.motcs.util.AnyDocConverterUtil;
import com.motcs.util.EnterpriseChunker;
...
public class DocumentService {
    ...
    public Mono<Void> processDocumentAsync(DocumentUploadRequest request, UploadContext context) {
        return Mono.fromRunnable(() -> {
            try {
                ...
                if (fineChunks.isEmpty()) throw new RuntimeException("文档内容为空或切分失败");
     ...
     */
    public Mono<DocumentStatsResponse> getStats(DocumentQueryRequest request) {
        return Mono.fromCallable(() -> {
